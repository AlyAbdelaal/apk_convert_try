                    ...
                    [
                        AppBar(
                            ...
                            actions=[
                                PopupMenuButton(
                                    items=[
                                        PopupMenuItem(text="معلومات عن التطبيق", on_click=lambda e: show_info("معلومات عن التطبيق")),
                                        PopupMenuItem(text="من نحن", on_click=lambda e: show_info("من نحن")),
                                        PopupMenuItem(text="تواصل مع المطورين", on_click=lambda e: show_info("تواصل مع المطورين")),
                            ...
                            actions=[
                                PopupMenuButton(
                                    items=[
                                        ...
                                        PopupMenuItem(text="من نحن", on_click=lambda e: show_info("من نحن")),
                                        PopupMenuItem(text="تواصل مع المطورين", on_click=lambda e: show_info("تواصل مع المطورين")),
                                    ],icon_color=light_color,bgcolor=light_color2,
